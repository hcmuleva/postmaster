...
export const ScenarioShow = () => {
  ...
  return (
    ...
    <Show isLoading={isLoading}>
      ...
      <RunStepModal visible={stepVisible} setVisible={setStepVisible}  variabledata={record?.variables} stepData={selectedStepData} setStepData={setSelectedStepData}  scenario={record}/>
      <RunScenarioModel runModalOpen={runModalOpen} setRunModalOpen={setRunModalOpen} scenarioid={record.id} scenario={record}></RunScenarioModel>
      <br />
