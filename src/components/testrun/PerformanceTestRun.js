...
const PerformanceTestRun = ({ open, setOpen, item }) => {
    ...
    const handleOk = async () => {
        ...
        {
          formdata['wll'] = [formdata.jmeterdata]
        }
        else
        {
        ...
        info(`Your ${auttype} test started`, body);
        const userobj = localStorage.getItem('user')
        const user = JSON.parse(userobj)
        formdata['auttype'] = auttype
    ...
    return (
        ...
        >
            ...
            <Row>
                <Col span={8}></Col>
                <Divider plain>{auttype} Work Load</Divider>
...
export default PerformanceTestRun;